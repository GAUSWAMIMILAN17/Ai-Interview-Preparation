...
const SummaryCard = ({
  ...
  return (
    <div
      className="bg-white border border-gray-300/40 rounded-xl p-4 overflow-hidden cursor hover:shadow-xl shadow-gray-100 group"
      onClick={onSelect}
    >
      {/* Top Colored Section */}
      <div
        className="p-4 rounded-lg cursor relative"
        style={{
