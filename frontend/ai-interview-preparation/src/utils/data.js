...
export const APP_FEATURES = [
  {
    ...
    description:
      "Get interview questions and model answers personalized to your role, experience level, and preferred technology stack.",
  },
  {
    id: "02",
    title: "Learn at Your Own Pace",
    description:
      "Expand answers only when needed and explore concepts in detail with AI-powered explanations and examples.",
  },
  {
    id: "03",
    title: "Capture Your Insights",
    description:
      "Save important notes, bookmark key questions, and organize your preparation with personal annotations.",
  },
  {
    id: "04",
    title: "Understand the 'Why'",
    description:
      "Go beyond memorization with detailed concept explanations, real-world examples, and interview tips.",
  },
  {
    id: "05",
    title: "Practice Mock Interviews",
    description:
      "Simulate real interview sessions with AI-generated questions, follow-up discussions, and instant feedback.",
  }
];